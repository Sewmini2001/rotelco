...
<html lang="en">
  <head>
    <title>Rotelco Technolab - RotelcoTechnolab</title>
    <meta charset="utf-8">
	        ...
	        <div class="container">
	          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
	            ...
	            <div class="col-md-12 ftco-animate text-center">
	              <h1 class="mb-2"> ROTELCO TECHNOLAB  </h1>
	              <h2 class="subheading mb-4"> 100% Best Service.Our primary focus is on biometric devices and software solutions for time attendance, access control. we also provide other services, such as IP-CCTV, Alarm Systems, Smart Home Systems, Guard Tour Patrol Systems, and customized software solutions according to requirements; </h2>
    ...
    <section class="ftco-section">
    	<div class="container">
          ...
          <div class="col-md-12 heading-section text-center ftco-animate">
            ...
            <p>"Our ZKTech fingerprint systems offer cutting-edge biometric technology for secure and efficient access control and time attendance solutions. Designed for reliability and ease of use, our systems provide accurate identification and verification, ensuring enhanced security and streamlined operations for businesses of all sizes."</p>
          </div>
        </div>
      </div>
    </section>
    	...
    	<div class="container">
          ...
          <div class="col-md-6 heading-section ftco-animate deal-of-the-day ftco-animate">
            ...
            <h2 class="mb-4">Discount of the day</h2>
            <p></p>
            <h3><a href="#"></a></h3>
