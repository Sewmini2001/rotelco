...
if ($product_id > 0) {
    $sql = "SELECT item_name, item_price, item_image, item_description FROM items WHERE id = ?";
...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="css/style.css">
		<link rel="stylesheet" href="css/productsingle.css">
  ...
  <body class="goto-here">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.php">RotelcoTechnolab</a>
...
<div class="container product-details-container">
    <div class="row">
        <div class="col-md-6 product-image">
            <a href="<?php echo htmlspecialchars($product['item_image']); ?>" class="image-popup" target="_blank">
                <img src="<?php echo htmlspecialchars($product['item_image']); ?>" class="img-fluid" alt="Product Image">
            </a>
        </div>
        <div class="col-md-6 product-info">
            <h3><?php echo htmlspecialchars($product['item_name']); ?></h3>
            <p class="price"><span>Rs. <?php echo number_format($product['item_price']); ?> /=</span></p>
            <div class="product-box">
                <p class="product-description"><?php echo nl2br(htmlspecialchars($product['item_description'])); ?></p>
            </div>
	...
	<script type="text/javascript">
	    ...
	    document.addEventListener('DOMContentLoaded', function() {
	        const product = {
	            ...
	            name: <?php echo json_encode($product['item_name']); ?>,
	            price: <?php echo json_encode($product['item_price']); ?>,
	            description: <?php echo json_encode($product['item_description']); ?>,
	            image: <?php echo json_encode($product['item_image']); ?>
	        };

	        document.getElementById('addToCartButton').addEventListener('click', function() {
	            localStorage.setItem('selectedProduct', JSON.stringify(product));
	            window.location.href = 'ItemSend.php';
	        });
	    });
	</script>
